...
@Entity
@Table(name = "tb_bin_device_params")
public class BinDeviceParams {
	...
	public Integer getOpening_1() {
		return opening_1;
	}
	public void setOpening_1(Integer opening_1) {
		this.opening_1 = opening_1;
	}
	...
	public Integer getOpening_2() {
		return opening_2;
	}
	public void setOpening_2(Integer opening_2) {
		this.opening_2 = opening_2;
	}
	...
	public Integer getOpening_3() {
		return opening_3;
	}
	public void setOpening_3(Integer opening_3) {
		this.opening_3 = opening_3;
	}
	...
	public Integer getOpening_4() {
		return opening_4;
	}
	public void setOpening_4(Integer opening_4) {
		this.opening_4 = opening_4;
	}
	...
	public BinDeviceParamsMessage convert() throws IOException{
		...
		byte[] opening1Bytes=new byte[]{(byte) (opening_1)};
		byte[] time1Data=Converter.byteArrsMerger(time1Bytes, opening1Bytes);
		...
		byte[] opening2Bytes=new byte[]{(byte) (opening_2)};
		byte[] time2Data=Converter.byteArrsMerger(time2Bytes, opening2Bytes);
		...
		byte[] opening3Bytes=new byte[]{(byte) (opening_3)};
		byte[] time3Data=Converter.byteArrsMerger(time3Bytes, opening3Bytes);
		...
		byte[] opening4Bytes=new byte[]{(byte) (opening_4)};
		byte[] time4Data=Converter.byteArrsMerger(time4Bytes, opening4Bytes);
		...
		bdpm.setDataLen(new byte[]{(byte) (dataLen/256),(byte) (dataLen%256)});
		return bdpm;
	}
	...
	public String toString() {
		return "<电机设备参数> [zoneName=" + zoneName + ", deviceName=" + deviceName + ", workDays="
				...
				+ opening_3 + ", time_4_start=" + time_4_start + ", time_4_end=" + time_4_end + ", opening_4="
				+ opening_4 + ", sensor_1_enable=" + sensor_1_enable + ", sensor_1_name=" + sensor_1_name
				+ ", upValueAction_1=" + upValueAction_1 + ", upValue_1=" + upValue_1 + ", midValueAction_1="
				+ midValueAction_1 + ", downValue_1=" + downValue_1 + ", downValueAction_1=" + downValueAction_1
				+ ", sensor_2_enable=" + sensor_2_enable + ", sensor_2_name=" + sensor_2_name + ", upValueAction_2="
				+ upValueAction_2 + ", upValue_2=" + upValue_2 + ", midValueAction_2=" + midValueAction_2
				+ ", downValue_2=" + downValue_2 + ", downValueAction_2=" + downValueAction_2 + ", sensor_3_enable="
				+ sensor_3_enable + ", sensor_3_name=" + sensor_3_name + ", upValueAction_3=" + upValueAction_3
				+ ", upValue_3=" + upValue_3 + ", midValueAction_3=" + midValueAction_3 + ", downValue_3=" + downValue_3
